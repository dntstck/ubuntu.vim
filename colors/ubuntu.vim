...
set background=dark
set t_Co=256
hi Normal guifg=#dadada ctermbg=NONE guibg=#380c2a gui=NONE
...
hi SignColumn guibg=#380c2a
hi Title guifg=#dadada
hi LineNr guifg=#747474 guibg=#380c2a
hi NonText guifg=#c481ff guibg=#380c2a
...
hi StatusLineNC gui=NONE guibg=#380c2a guifg=#dadada
