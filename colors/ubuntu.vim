" -----------------------------------------------------------------------------
" File: ubuntu.vim
" Description: ubuntu colors for vim, based on gruvbox (thanks morhetz)
" Author: dntstck / dntstck@icloud.com
" Source: https://github.com/dntstck/ubuntu.vim
...
let s:gb.dark0_hard  = ['#380C2A', 234]     " 29-32-33
let s:gb.dark0       = ['#380C2A', 235]     " 40-40-40
let s:gb.dark0_soft  = ['#380C2A', 236]     " 50-48-47
let s:gb.dark1       = ['#380C2A', 237]     " 60-56-54
let s:gb.dark2       = ['#380C2A', 239]     " 80-73-69
let s:gb.dark3       = ['#380C2A', 241]     " 102-92-84
let s:gb.dark4       = ['#380C2A', 243]     " 124-111-100
let s:gb.dark4_256   = ['#380C2A', 243]     " 124-111-100
